...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Internal Projects</li>
        </ol>
    </nav>
</div>
<h1 class="text-center mb-3"><label for="internalProjects" class="form-label"><strong>Internal Projects</strong></label></h1>
